    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                script {
                    dir('terraform') {
                        git url: 'https://github.com/CubeMart/infrastructure.git', branch: 'main'
                    }
                }
            }
        }
        ...
        stage('Plan: 0-bootstrap') {
            ...
            steps {
                ...
                sh 'cd terraform/0-bootstrap && terraform import aws_s3_bucket.tf_state cubemart-infra-statefile-backup || true'
                sh 'cd terraform/0-bootstrap && terraform import aws_dynamodb_table.tf_lock cubemart-terraform-locks || true'
